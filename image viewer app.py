...
def forward(image_number):
    ...
    status = Label(root, text="Image"+ str(image_number) + "of" + str(image_number), bd=1, relief=SUNKEN, anchor=E))
...
button_back = Button(root, text="cc", command=back, state=DISABLED)
